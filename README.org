...
* News
- 18/09/26 :: Thanks to https://github.com/m42e/zsh-histdb-fzf and claude I have mangled together an fzf thing.
...
** fzf
Another thing you can use is fzf
...
see histdb-isearch-fzf-glue for more examples.
* Database schema
